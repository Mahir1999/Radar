...
# --- إعدادات الصفحة ---
st.set_page_config(page_title="Greedy AI v94.1", page_icon="🛡️", layout="centered")
...
st.markdown("""
    ...
    /* إزالة الخلفية والحدود من منطقة الأزرار */
    .no-frame { margin-top: 10px; }
    </style>
...
if total_h > 20 and st.session_state.consecutive_misses >= 3:
    st.error("🚨 مستشار الانسحاب: السيرفر في وضع استرداد!")
...
# --- 4. شريط النمط والأنماط (تمت الاستعادة) ---
